...
public class SearchBoardController {
   ...
   @RequestMapping("/read")
   public void read(int bno, SPageTO<BoardVO> sto, Model model) {
   ...
   @RequestMapping("/del")
   public String del(int bno, SPageTO<BoardVO> sto) throws Exception{
      sbService.del(bno);
   ...
   public void modifyUI(int bno, SPageTO<BoardVO> sto, Model model) {
